...
import SignalCellularAlt from './../../../assets/images/icons/signal_cellular.svg';
...
const BandwidthUsageCard = (props) => {
                ...
                <Grid container direction="column">
                    <Grid item>
                        <Grid container justifyContent="space-between">
                            {anchorEl ? null : <Grid item>
                                ...
                                <img src={SignalCellularAlt} alt="BandwidthUsage" />
                                </Avatar>
                            </Grid> }
                            <Grid item>
                                <Avatar
                    ...
                    <Grid item>
                        <Grid container alignItems="center">
                            <Grid item>
                                <Typography className={classes.cardHeading}>{props.bikes} ms</Typography>
                            </Grid>
                            <Grid item>
                    ...
                    <Grid item>
                        <Typography className={classes.subHeading}>Bandwidth Usage</Typography>
                    </Grid>
                </Grid>
