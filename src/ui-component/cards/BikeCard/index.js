...
import LocalMallOutlinedIcon from './../../../assets/images/icons/bike.svg';
                ...
                <Grid container direction="column">
                    <Grid item>
                        <Grid container justifyContent="space-between">
                            {anchorEl ? null : <Grid item>
                                ...
                                <img src={LocalMallOutlinedIcon} alt="Bike" />
                                </Avatar>
                            </Grid> }
                            <Grid item>
                                <Avatar
                    ...
                    <Grid item>
                        <Grid container alignItems="center">
                            <Grid item>
                                <Typography className={classes.cardHeading}>{props.bikes}/Hour</Typography>
                            </Grid>
                            <Grid item>
                    ...
                    <Grid item>
                        <Typography className={classes.subHeading}>Bikes</Typography>
                    </Grid>
                </Grid>
