...
import ConnectedUsers from './../../../assets/images/icons/connectedusers.svg';
...
const ConnectedUsersCard = (props) => {
                ...
                <Grid container direction="column">
                    <Grid item>
                        <Grid container justifyContent="space-between">
                            {anchorEl ? null : <Grid item>
                                ...
                                <img src={ConnectedUsers} alt="Bike" />
                                </Avatar>
                            </Grid> }
                            <Grid item>
                                <Avatar
                    ...
                    <Grid item>
                        <Grid container alignItems="center">
                            <Grid item>
                                <Typography className={classes.cardHeading}>{props.bikes} users</Typography>
                            </Grid>
                            <Grid item>
                    ...
                    <Grid item>
                        <Typography className={classes.subHeading}>Connected Users</Typography>
                    </Grid>
                </Grid>
